...
@WebMvcTest(controllers = HelloController.class, excludeFilters = { //여러 스프링 어노테이션 중, web(spring MVC)에 집중할 수 있는 어노테이션
                        @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = SecurityConfig.class)}) //@Controller, @ControllerAdvice 등 사용 가능(@Service, @component, @Repository 등 은 사용 불가)
